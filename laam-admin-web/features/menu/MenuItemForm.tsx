...
// menu (`laam-web/components/screens/admin-screen.tsx`'s `badgeColorOptions`)
...
type MenuItemFormProps = {
   ...
   * before creating a new item. `laam-api` generates each item's id itself
   * (`fmt.Sprintf("menu-%d", time.Now().UnixMilli())`,
   * `laam-api/internal/store/postgres.go`) and the create response only
   ...
   * `laam-web/components/screens/admin-screen.tsx`'s `handleMenuSubmit`).
