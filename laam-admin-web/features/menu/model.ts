 ...
 *
 * Field names below are grounded in `laam-api/internal/httpapi/router.go`'s
...
/**
 * Mirrors `laam-api/internal/lamdata.CatalogSyncResponse` — the manual
...
/**
 * Mirrors `laam-api/internal/lamdata.MenuItemRecipe` — admin-only ingredient
...
/**
 * `laam-api` accepts any multipart file for an image upload without a
