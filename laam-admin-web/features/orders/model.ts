/**
 * Mirrors `laam-api/internal/lamdata.PaymentOrder` — the admin read shape,
 * deliberately kept separate from `laam-web`'s customer-facing payment
...
/** Mirrors `laam-api/internal/lamdata.PaymentOrderPage`. */
