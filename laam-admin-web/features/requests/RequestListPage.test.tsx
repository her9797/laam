...
describe("RequestListPage", () => {
  ...
  // again to restore it (a real remount, or a fresh render with dates
  // already in the URL, would never hit this).
  it("recovers the list when the URL query is cleared by a same-route re-navigation", () => {
    ...
    const { rerender } = render(<RequestListPage kind="general" />);
