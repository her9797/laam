...
// setInputs) still reaches lam-api. Toss gives no other way to see a
// deployed worker plugin's console short of wiring up Sentry.
const DIAGNOSTICS_URL = "https://lam-api-760602987859.asia-northeast3.run.app/api/v1/pos-plugin/diagnostics";
  ...
  await sdk.setting.setInputs([
    {
      ...
      required: true,
      default: "",
      placeholder: "https://lam-api-...run.app"
    },
    {
      id: "apiToken",
      type: "password",
      ...
      required: true,
      default: "",
      placeholder: "Secret Manager의 lam-pos-plugin-api-token 값"
    },
    {
      id: "tableMappings",
      type: "text",
